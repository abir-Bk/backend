...
import com.example.yakdhan.service.*;
...
public class produitcontroller {
    ...
    public ResponseEntity<Produit> ajouterProduit(
        ...
        Optional<Categorie> optionalCategorie = Optional.ofNullable(categorieService.getCategorieById(categorieId));
        ...
        produit.setAdresseIp(adresseIp);
        ...
        if (!imageFile.isEmpty()) {
            try {
                ...
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(null); // Error handling for file
                                                                                           // upload
            }
        }
